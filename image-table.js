    ...
    return (
        <div className="table-container">
            <table className="styled-table">
                <thead>
                    <tr>
                        <th style={{ border: '1px solid #3824', padding: '8px', textAlign:'center', backgroundColor: 'lightblue'}}>Image</th>
                        <th style={{ border: '1px solid #3824', padding: '8px', textAlign:'center', backgroundColor: 'lightblue'}}>Name</th>
                    </tr>
                </thead>
                <tbody>
